...
class BuildingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create building" do
    assert_difference('Building.count') do
      post buildings_url, params: { building: { address: @building.address, code: @building.code, title: @building.title } }
    end
  ...
  test "should update building" do
    patch building_url(@building), params: { building: { address: @building.address, code: @building.code, title: @building.title } }
